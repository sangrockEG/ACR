...
class VOC12ClsDataset_SelfSup(VOC12ImageDataset_SelfSup):
    ...
    def __init__(self, img_name_list_path, voc12_root, crop, resize, cj):
        ...
        self.crop = crop
        self.flag_asym_crop = True #self.crop[0]==self.crop[1]
        self.resize = resize
        self.cj = cj
        assert resize[0]>150
    ...
    def apply_tf(self, img, rc=None):
        ...
        # img = self.tf_cj(img) #RECON : False
        ...
        # img_vgg = self.tf_norm_vgg(img_vgg)
        img_ori2= img_vgg
    ...
    def __getitem__(self, idx):
        ...
        if self.flag_asym_crop:
            img_A,_,_ = self.apply_tf(img, rc='A')
...
class VOC12ClsDatasetRecon(Dataset):

    def __init__(self, img_name_list_path, voc12_root, crop, resize):
